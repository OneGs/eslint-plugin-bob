    ...
    create(context) {
        ...
        return utils.defineTemplateBodyVisitor(context, {}, {
            'Identifier[name=/columns/]': function (node) {
                ...
                _coreColumns.map(node => {coreCount[getColumnOrderLabelByNode(node)] += 1})
                ...
                function hasMultiSameLabel() {
                    return Object.values(coreCount).some(count => count > 1)
                }
